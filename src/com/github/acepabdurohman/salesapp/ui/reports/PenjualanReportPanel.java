...
public class PenjualanReportPanel extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.title")); // NOI18N

        dateChooserFrom.setDateFormatString(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.dateChooserFrom.dateFormatString")); // NOI18N

        btnDisplay.setText(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.btnDisplay.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.jLabel1.text")); // NOI18N

        dateChooserTo.setDateFormatString(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.dateChooserTo.dateFormatString")); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText(org.openide.util.NbBundle.getMessage(PenjualanReportPanel.class, "PenjualanReportPanel.jLabel2.text")); // NOI18N
    ...
    private void btnDisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayActionPerformed
        ...
        try{
            InputStream is = PenjualanReportPanel.class.getResourceAsStream("/reports/ReportPenjualan.jrxml");
