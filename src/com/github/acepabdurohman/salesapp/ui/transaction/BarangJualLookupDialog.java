...
/*
    Panel lookup untuk setiap barang yang akan dijual
*/
public class BarangJualLookupDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.title")); // NOI18N

        txtCari.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.txtCari.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.jLabel1.text")); // NOI18N
        ...
        btnOk.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnOk.text")); // NOI18N
        ...
        btnBatal.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnBatal.text")); // NOI18N
        ...
        btnLast.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnLast.text")); // NOI18N
        ...
        btnNext.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnNext.text")); // NOI18N
        ...
        btnPrevious.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnPrevious.text")); // NOI18N
        ...
        btnFirst.setText(org.openide.util.NbBundle.getMessage(BarangJualLookupDialog.class, "BarangJualLookupDialog.btnFirst.text")); // NOI18N
